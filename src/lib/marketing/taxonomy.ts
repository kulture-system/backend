...
export const facilityServices: ServiceEntry[] = [
    {
        ...
        metaDescription: 'Reliable CNA staffing for nursing homes, assisted living and memory care across Washington — per diem, temporary, weekend and short-notice coverage.',
        keywords: ['CNA staffing agency', 'temporary CNA staffing', 'per diem CNA', 'short notice CNA staffing', 'nursing home CNA staffing'],
        intro: 'Pristine Health provides credentialed Certified Nursing Assistants to senior living, skilled nursing and memory care communities across Washington — for planned coverage, call-outs and short-notice gaps.',
    ...
    },
    {
        ...
        metaDescription: 'Dedicated 1:1 sitter and patient observer staffing for hospitals and senior care facilities in Washington — reduce fall risk with reliable one-to-one supervision.',
    ...
    },
    {
        ...
        metaDescription: 'Dependable CNA, caregiver and med tech staffing for assisted living communities across Washington — planned coverage and short-notice support.',
    ...
    },
    {
        ...
        metaDescription: 'CNA, LPN and RN staffing for skilled nursing facilities and nursing homes in Washington — per diem, temporary and contract coverage.',
        ...
        intro: 'Pristine Health provides CNAs, LPNs and RNs to skilled nursing facilities across Washington — for per diem, temporary and contract coverage that protects resident care.',
    ...
    },
    {
        ...
        metaDescription: 'Compassionate, experienced CNA and caregiver staffing for memory care communities in Washington.',
    ...
    },
    {
        ...
        metaDescription: 'Licensed Practical Nurse staffing for facilities across Washington — per diem, temporary and short-notice coverage.',
        keywords: ['LPN staffing agency', 'temporary LPN staffing', 'per diem LPN'],
        intro: 'Pristine Health provides Licensed Practical Nurses for facilities across Washington, from planned coverage to short-notice needs.',
    ...
    },
    {
        ...
        metaDescription: 'Registered Nurse staffing for facilities across Washington — per diem, temporary and short-notice coverage.',
        keywords: ['RN staffing agency', 'temporary RN staffing', 'per diem nursing staff'],
        intro: 'Pristine Health provides Registered Nurses for facilities across Washington, supporting planned schedules and short-notice coverage.',
    ...
    },
    {
        ...
        metaDescription: 'Medication technician staffing for assisted living and senior care communities across Washington.',
        keywords: ['med tech staffing agency', 'medication technician staffing', 'med tech staffing assisted living'],
        intro: 'Pristine Health provides qualified medication technicians for assisted living and senior care communities across Washington.',
    ...
    },
    {
        ...
        metaDescription: 'Dependable caregiver staffing for senior living and care communities across Washington.',
        keywords: ['caregiver staffing agency', 'temporary caregivers', 'caregiver staffing for facilities'],
        intro: 'Pristine Health provides dependable caregivers for senior living and care communities across Washington — planned coverage and short-notice support.',
    ...
    },
    {
        ...
        metaDescription: 'Staffing for behavioral health settings across Washington, including behavioral sitters and one-to-one support.',
        keywords: ['behavioral health staffing agency', 'behavioral sitter staffing', 'patient observer staffing'],
        intro: 'Pristine Health supports behavioral health settings across Washington with experienced staff and dedicated one-to-one behavioral sitters.',
    ...
    },
    {
        ...
        metaDescription: 'Short-notice and same-day healthcare staffing for facilities across Washington — cover call-outs and shift gaps fast.',
...
export const homeCareServices: ServiceEntry[] = [
    {
        ...
        metaDescription: 'Compassionate in-home personal care for seniors across Washington — bathing, dressing, mobility and daily living support. Private pay, non-medical home care.',
    ...
    },
    {
        ...
        metaDescription: 'Friendly companion care for seniors across Washington — conversation, activities, errands and everyday support at home.',
    ...
    },
    {
        ...
        metaDescription: 'Short-term respite care across Washington gives family caregivers a break while your loved one is cared for at home.',
    ...
    },
    {
        ...
        metaDescription: 'Specialized in-home dementia and Alzheimer’s care across Washington — patient, experienced caregivers who support safety and routine.',
    ...
    },
    {
        ...
        metaDescription: 'Overnight caregivers across Washington provide safety, reassurance and support through the night at home.',
    ...
    },
    {
        ...
        metaDescription: 'Around-the-clock in-home care across Washington — continuous support so seniors can remain safely at home.',
    ...
    },
    {
        ...
        metaDescription: 'In-home recovery support after a hospital stay across Washington — reduce readmission risk with help at home.',
    ...
    },
    {
        ...
        metaDescription: 'Dedicated one-to-one in-home care across Washington for seniors who need focused, individualized support.',
